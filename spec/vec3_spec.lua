...
describe("vec3:", function()
	...
	it("projects two vectors", function()
		local a = vec3(3, 5, 7)
		assert.is.equal(a:project(vec3(1,0,0)), vec3(3,0,0))
		assert.is.equal(a:project(vec3(0,1,0)), vec3(0,5,0))
		assert.is.equal(a:project(vec3(0,0,1)), vec3(0,0,7))
		assert.is.equal(a:project(vec3(10,0,0)), vec3(3,0,0))
		assert.is.equal(a:project(vec3(0,10,0)), vec3(0,5,0))
		assert.is.equal(a:project(vec3(0,0,10)), vec3(0,0,7))
		assert.is.equal(a:project(vec3(6,10,14)), a)
